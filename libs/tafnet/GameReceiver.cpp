...
void GameReceiver::onNewConnection()
{
    try
    {
        taflib::Watchdog wd("GameReceiver::onNewConnection", 100);
...
void GameReceiver::onSocketStateChanged(QAbstractSocket::SocketState socketState)
{
    try
    {
        taflib::Watchdog wd("GameReceiver::onSocketStateChanged", 100);
...
void GameReceiver::onReadyReadTcp()
{
    try
    {
        taflib::Watchdog wd("GameReceiver::onReadyReadTcp", 100);
...
void GameReceiver::onReadyReadUdp()
{
    try
    {
        taflib::Watchdog wd("GameReceiver::onReadyReadUdp", 100);
