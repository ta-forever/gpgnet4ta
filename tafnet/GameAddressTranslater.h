...
namespace tafnet
{
    class GameAddressTranslater
    {
        ...
        std::function<bool(TADemo::DPAddress & address, int /* 0:tcp, 1:udp */)> translatePlayerSPA;

    public:
        typedef std::function<bool(TADemo::DPAddress & address, int /* 0:tcp, 1:udp */)> TranslatePlayerSPA;
    ...
    private:
        void translateReplyAddress(TADemo::DPAddress& address, int index) const;
    };
